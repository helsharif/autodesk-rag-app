...
from src.config import LIGHTRAG_AUTODESK_WEB_MODE, OPTION_4_LABEL, SEARCH_MODE_OPTIONS
...
class Option4LightRAGTests(unittest.TestCase):
    def test_option4_is_exposed_as_search_mode(self):
        self.assertEqual(SEARCH_MODE_OPTIONS[OPTION_4_LABEL], LIGHTRAG_AUTODESK_WEB_MODE)
    ...
    def test_option4_web_query_is_scoped_to_autodesk(self):
        agent = AutodeskRAGAgent.__new__(AutodeskRAGAgent)
        agent.search_mode = LIGHTRAG_AUTODESK_WEB_MODE
