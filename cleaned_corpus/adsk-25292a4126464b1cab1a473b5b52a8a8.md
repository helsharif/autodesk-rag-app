...
heading_count: 7
subheading_count: 6
headings: "h1: Terms and conditions | Autodesk FY21 Transition to Named User Program | h2: General information | h3: 1. What’s changing & why? | h3: 2. What do I need to do to transition to named user? | h3: 3. Multi-user trade-in offer | h3: 4. Quick reference overview of transition options | h3: 5. Trade-In Product Exceptions"
subheadings: "General information | 1. What’s changing & why? | 2. What do I need to do to transition to named user? | 3. Multi-user trade-in offer | 4. Quick reference overview of transition options | 5. Trade-In Product Exceptions"
raw_char_count: 72075
cleaned_char_count: 7101
tfidf_keyword_count: 12
tfidf_keywords: "trade-in | multi-user | february | subscription | trade-in offer | renewed | subscriptions | new subscription | network maintenance | lower price | maintenance | eligible"
---
