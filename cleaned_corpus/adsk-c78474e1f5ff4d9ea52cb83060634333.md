...
heading_count: 3
subheading_count: 2
headings: "h1: McKinstry Experiences 50% Time-Savings with Assemble for Earned Value Tracking | h2: “I can sort and filter the data from Assemble by installation status and activity IDs in seconds to see quantities in... | h2: “Assemble is a multi-faceted tool that can be used in so many different waysIf you are familiar with pivot tables in..."
subheadings: "“I can sort and filter the data from Assemble by installation status and activity IDs in seconds to see quantities in... | “Assemble is a multi-faceted tool that can be used in so many different waysIf you are familiar with pivot tables in..."
raw_char_count: 142084
cleaned_char_count: 4030
tfidf_keyword_count: 12
tfidf_keywords: "assemble | mckinstry | earned value | earned | tracking | value | project | ductwork | piece | team | inaccurate | floor"
---
